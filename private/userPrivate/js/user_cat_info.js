...
async function loadCatIndividualData() {
    ...
    catIntroHtml += `
    <h2 class="u-align-left u-text u-text-default u-text-palette-5-dark-3 u-text-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
        <i class="fa-solid fa-file"></i> 簡介
    </h2>
    <p class="u-align-left u-text u-text-default-lg u-text-default-xl u-text-2">${catProfile.intro}</p>
    <a href="user_apply_note.html?id=${urlSearchParams.get("id")}" class="u-active-palette-3-light-1 u-border-none u-btn u-btn-round u-button-style u-custom-color-13 u-hover-palette-3-light-1 u-radius-20 u-text-active-custom-color-4 u-text-hover-custom-color-4 u-btn-1">申請領養</a>
    `;
