    ...
    if ("message" in volPostedCat) {
        ...
        for (let post of volPostedCat) {
            ...
            <div class="cat-card" id="card-${post.id}" style="height: 420px">
                <a href="vol_editAdoptCase.html?caseID=${post.id}"><img src="${
                post.c_image
            }" width="200px" class="cat-image"></a>
                <a href="vol_editAdoptCase.html?caseID=${post.id}"><div style="color: #ffffff;">
                    <div class="cat-name"><i class="fa-solid fa-paw"></i>${post.c_name.slice(
                        0,
                        6
                    )}</div>
                ...
                <div style="display: flex; justify-content: end">
                    <div><a href="vol_editAdoptCasePage.html?caseID=${
                        post.id
                    }"><i class="fa-solid fa-pen"></i></a></div>
                    <div class="delete"><i class="fa-solid fa-trash-can" data-mid="card-${
                        post.id
                    }"></i></div>
                </div></div>
            `;
