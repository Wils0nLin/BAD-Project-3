    ...
    for (let post of volPostedCat) {
      htmlStr += `
            <div class="cat-card" id="card-${post.id}" style="height: 420px">
                <a href="volunteer_post_info.html?caseID=${post.id}"><img src="${post.c_image}" width="200px" class="cat-image"></a>
                <a href="volunteer_post_info.html?caseID=${post.id}"><div style="color: #ffffff;">
