...
async function loadCatCard() {
    ...
    for (const cat of cats) {
        catAdoptHtml += `
        <div class="u-align-left-xs u-container-style u-grey-70 u-list-item u-radius-15 u-repeater-item u-shape-round u-list-item-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500" data-href="public_cat_info.html?id=${cat.id}">
